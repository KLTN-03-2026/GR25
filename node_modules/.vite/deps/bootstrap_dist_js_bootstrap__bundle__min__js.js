	...
	(function(t, e) {
		...
		class xt extends W {
			...
			_addTouchEventListeners() {
				...
				this._swipeHelper = new st(this._element, {
		...
		N.on(document, bt, "[data-bs-slide], [data-bs-slide-to]", (function(t) {
			...
			n ? (i.to(n), i._maybeEnableCycle()) : "next" === F.getDataAttribute(this, "slide") ? (i.next(), i._maybeEnableCycle()) : (i.prev(), i._maybeEnableCycle());
		})), N.on(window, _t, (() => {
		...
		const ai = {
			...
			requiresIfExists: ["preventOverflow"],
			fn: function(t) {
				var e = t.state, i = t.name, n = e.rects.reference, s = e.rects.popper, o = e.modifiersData.preventOverflow, r = ii(e, { elementContext: "reference" }), a = ii(e, { altBoundary: !0 }), l = oi(r, n), c = oi(a, s, o), h = ri(l), d = ri(c);
				e.modifiersData[i] = {
			...
			fn: function(t) {
				var e = t.state, i = t.options, n = t.name, s = i.offset, o = void 0 === s ? [0, 0] : s, r = ee.reduce((function(t, i) {
					return t[i] = function(t, e, i) {
						var n = be(t), s = [Vt, zt].indexOf(n) >= 0 ? -1 : 1, o = "function" == typeof i ? i(Object.assign({}, e, { placement: t })) : i, r = o[0], a = o[1];
			...
			fn: function(t) {
				var e = t.state, i = t.options, n = t.name, s = i.mainAxis, o = void 0 === s || s, r = i.altAxis, a = void 0 !== r && r, l = i.boundary, c = i.rootBoundary, h = i.altBoundary, d = i.padding, u = i.tether, f = void 0 === u || u, p = i.tetherOffset, m = void 0 === p ? 0 : p, g = ii(e, {
					...
					padding: d,
					altBoundary: h
				}), _ = be(e.placement), b = Fe(e.placement), v = !b, y = Ie(_), w = "x" === y ? "y" : "x", A = e.modifiersData.popperOffsets, E = e.rects.reference, T = e.rects.popper, C = "function" == typeof m ? m(Object.assign({}, e.rects, { placement: e.placement })) : m, O = "number" == typeof C ? {
					mainAxis: C,
					altAxis: C
				} : Object.assign({
					mainAxis: 0,
		...
		var gi = mi(), _i = mi({ defaultModifiers: [
			Re,
			ci,
			Be,
			_e
		] }), bi = mi({ defaultModifiers: [
			Re,
			ci,
			Be,
			_e,
		...
		class cs extends W {
			...
			_createPopper(t) {
				const i = rs[g(this._config.placement, [
					this,
					t,
					this._element
				]).toUpperCase()];
