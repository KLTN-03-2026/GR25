          ...
          <transition name="dropdown-smooth">
            <div v-show="showMenu" 
              ...
              <div style="padding: 8px 0;">
                ...
                <router-link to="/cai-dat" style="display: flex; align-items: center; gap: 10px; padding: 12px 16px; color: #374151; text-decoration: none; font-size: 14px; transition: background 0.15s ease, padding-left 0.15s ease;">
