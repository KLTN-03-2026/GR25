import { $n as toRefs, At as onBeforeMount, Ft as onMounted, Kn as ref, Ot as nextTick, Rt as onServerPrefetch, Vt as openBlock, ar as normalizeClass, gn as watch, jt as onBeforeUnmount, nt as defineComponent, pt as h, q as createElementBlock, ut as getCurrentInstance } from "./vue.runtime.esm-bundler-CJdF6Oq_.js";
...
var C = [
	...
	emits: C,
	setup(t, { emit: s }) {
		const r = ref(null), n = ref(null), l = (e) => e && typeof e == "object" && !Array.isArray(e) && e != null, g = (e, o) => {
			typeof Object.assign != "function" && function() {
				Object.assign = function(a) {
					...
					for (let c = 1; c < arguments.length; c++) {
						let p = arguments[c];
						if (p != null) for (let O in p) p.hasOwnProperty(O) && (m[O] = p[O]);
					}
					return m;
				};
			}();
			...
			return l(e) && l(o) && Object.keys(o).forEach((a) => {
				l(o[a]) ? a in e ? i[a] = g(e[a], o[a]) : Object.assign(i, { [a]: o[a] }) : Object.assign(i, { [a]: o[a] });
			}), i;
		}, u = (e) => JSON.parse(JSON.stringify(e)), v = async () => {
			if (await nextTick(), n.value) return;
			const e = {
				chart: {
			...
			return n.value = new ApexCharts(r.value, i), n.value.render();
		}, y = () => (S(), v()), S = () => {
		...
		onBeforeMount(() => {
			...
			r.value = getCurrentInstance().proxy.$el, v();
		}), onBeforeUnmount(() => {
			n.value && S();
		});
		const d = toRefs(t);
		...
		const b = (e) => {
			h || (h = {
				...
				} else o.options ? n.value.updateOptions(u(t.options)) : o.series && n.value.updateSeries(u(t.series));
			})), h[e] = !0;
		};
		return watch(d.options, () => {
			b("options");
		}), watch(d.series, () => {
			b("series");
		}, { deep: !0 }), watch(d.type, () => {
	...
	setup(t) {
		...
		return onServerPrefetch(async () => {
			try {
				const { default: r } = await import("./apexcharts.ssr.esm-fe46cd2d-D6qPXgqD.js"), n = Object.assign({}, t.options, {
...
var M = /* @__PURE__ */ oe(ae, [["render", se]]), P = defineComponent({
	...
	setup(t) {
		...
		onMounted(async () => {
			try {
				const { default: r } = await import("./apexcharts.ssr.esm-fe46cd2d-D6qPXgqD.js");
...
x.install = ie;
//#endregion
export { P as ApexChartsHydrate, M as ApexChartsServer, x as default };
